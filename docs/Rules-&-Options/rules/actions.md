...
If an item requires an action to activate, that action isn't a function of the [Use an Object](actions.md##Use%20an%20Object) action, so a feature such as the rogue's [Fast Hands](5e-compendium/classes/rogue-thief.md#Fast%20Hands%20(Level%203)) can't be used to activate the item.
...
See also: [Attack](actions.md##Attack), [Shove Aside](actions.md.md###Shove%20Aside)
