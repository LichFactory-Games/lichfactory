...
The [calm emotions](../../../../calm-emotions.md) spell effect used to suppress the [charmed](../conditions.md##charmed) and [frightened](../conditions.md##frightened) conditions also suppresses the effects of one's Stress Score for the spell's duration.

A [lesser restoration](../../../../lesser-restoration.md) spell reduces the target's Stress Score by 1, and a [greater restoration](../../../../greater-restoration.md) spell reduces a character's Stress Score to 0.