...
Proficiency with [brewer's supplies](../../../../brewers-supplies.md.md) gives you additional insight on Intelligence ([History](../skills.md##History)) checks concerning events that involve alcohol as a significant element.
...
A stiff drink can help soften the hardest heart. Your proficiency with [brewer's supplies](../../../../brewers-supplies.md.md) can help you ply someone with drink, giving them just enough alcohol to mellow their mood.
...
A [forgery kit](../../../../forgery-kit.md.md) includes several different types of ink, a variety of parchments and papers, several quills, seals and sealing wax, gold and silver leaf, and small tools to sculpt melted wax to mimic a seal.

#### Arcana

A [forgery kit](../../../../forgery-kit.md.md) can be used in conjunction with the [Arcana](../skills.md.md###Arcana) skill to determine if a magic item is real or fake.
...
A [forgery kit](../../../../forgery-kit.md.md) combined with your knowledge of history improves your ability to create fake historical documents or to tell if an old document is authentic.

#### Investigation

When you examine objects, proficiency with a [forgery kit](../../../../forgery-kit.md.md) is useful for determining how an object was made and whether it is genuine.

#### Other Tools

Knowledge of other tools makes your forgeries that much more believable. For example, you could combine proficiency with a [forgery kit](../../../../forgery-kit.md.md) and proficiency with [cartographer's tools](../../../../cartographers-tools.md) to make a fake map.

#### Quick Fake

As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](../../../../forgery-kit.md.md) determines the DC for someone else's Intelligence ([Investigation](../skills.md.md###Investigation)) check to spot the fake.
...
Proficiency with [jeweler's tools](../../../../jewelers-tools.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](../skills.md.md.md####Arcana) checks related to gems or gem-encrusted items.
...
[Mason's tools](../../../../masons-tools.md.md) consist of a trowel, a hammer, a chisel, brushes, and a square.
...
[Tinker's tools](../../../../tinkers-tools.md.md.md) include a variety of hand tools, thread, needles, a whetstone, scraps of cloth and leather, and a small pot of glue.
