...
- (a) a [rapier](rapier.md#.md#) or (b) a [shortsword](shortsword.md#.md#)  
- (a) a [shortbow](shortbow.md#) and [quiver](quiver.md#) of [20 arrows](arrows-20.md#) or (b) a [shortsword](shortsword.md#.md#.md#)  
- (a) a [burglar's pack](burglars-pack.md#), (b) a [dungeoneer's pack](dungeoneers-pack.md#), or (c) an [explorer's pack](explorers-pack.md#)  
- [Leather armor](leather-armor.md#), two [daggers](dagger.md#), and [thieves' tools](thieves-tools.md#.md#)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: [thieves' tools](thieves-tools.md#.md#.md#)
...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [charlatan](../../backgrounds/charlatan.md#) background.
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](thieves-tools.md#.md#.md#.md#). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](thieves-tools.md#.md#.md#.md#.md#)) to gain this benefit.

### Sneak Attack (Level 1)

Beginning at 1st level, you know how to strike subtly and exploit a foe's distraction. Once per turn, you can deal an extra `1d6` damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon.

You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](../../../Rules%20&%20Options/5e%20Rules/conditions.md##incapacitated), and you don't have disadvantage on the attack roll.
...
Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the [Dash](../../../Rules%20&%20Options/5e%20Rules/actions.md##Dash), [Disengage](../../../Rules%20&%20Options/5e%20Rules/actions.md##Disengage), or [Hide](../../../Rules%20&%20Options/5e%20Rules/actions.md##Hide) action.
...
*3rd-level rogue [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#)*
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](thieves-tools.md#.md#.md#.md#.md#.md#)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](../../spells/ice-storm.md#) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](../../../Rules%20&%20Options/5e%20Rules/conditions.md##invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](../../../Rules%20&%20Options/5e%20Rules/conditions.md.md##incapacitated).
