...
- (a) a [quarterstaff](quarterstaff.md#.md#) or (b) a [dagger](dagger.md#.md#)  
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](../../backgrounds/sage.md#) background. Third, choose the [mage hand](../../spells/mage-hand.md#), [light](../../spells/light.md#), and [ray of frost](../../spells/ray-of-frost.md#) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](../../spells/burning-hands.md#), [charm person](../../spells/charm-person.md#), [feather fall](../../spells/feather-fall.md#), [mage armor](../../spells/mage-armor.md#), [magic missile](../../spells/magic-missile.md#), and [sleep](../../spells/sleep.md#).
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](../../spells/magic-missile.md#.md#), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](../../../Rules%20&%20Options/5e%20Rules/skills.md##Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
...
*3rd-level wizard [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#)*
