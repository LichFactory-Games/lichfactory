...
- **Armor**: light, medium, [shields](shield.md#.md#)
- **Weapons**: simple, martial
- **Tools**: none
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](../../backgrounds/outlander.md#) background.
...
You have advantage on Wisdom ([Survival](../../../Rules%20&%20Options/5e%20Rules/skills.md##Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
*1st-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#), which replaces the Favored Enemy feature and works with the Foe Slayer feature*

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](../../../Rules%20&%20Options/5e%20Rules/conditions.md##concentration) (as if you were concentrating on a spell).
...
*1st-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#.md#), which replaces the Natural Explorer feature*
...
- [Archery](../../optional-features/archery.md#)  
- [Defense](../../optional-features/defense.md#)  
- [Dueling](../../optional-features/dueling.md#)  
- [Two-Weapon Fighting](../../optional-features/two-weapon-fighting.md#)  
...
For example, if you know the 1st-level spell [animal friendship](../../spells/animal-friendship.md#) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](../../spells/animal-friendship.md#) using either slot.
...
*2nd-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#.md#.md#)*
...
*3rd-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#.md#.md#.md#), which replaces the Primeval Awareness feature*
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](../../spells/speak-with-animals.md#) |
| 5th | [beast sense](../../spells/beast-sense.md#) |
| 9th | [speak with plants](../../spells/speak-with-plants.md#) |
| 13th | [locate creature](../../spells/locate-creature.md#) |
| 17th | [commune with nature](../../spells/commune-with-nature.md#) |
^primal-awareness-spells
...
*4th-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#.md#.md#.md#.md#)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a fighting style you know with another fighting style available to rangers. This replacement represents a shift of focus in your martial practice.

### Extra Attack (Level 5)

Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](../../../Rules%20&%20Options/5e%20Rules/actions.md##Attack) action on your turn.
...
Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](../../../Rules%20&%20Options/5e%20Rules/skills.md##Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)
_Source: Tasha's Cauldron of Everything p. 56_

*10th-level ranger [optional class features](../../../Rules%20&%20Options/5e%20Rules/variant-rules/optional-class-features-tce.md#.md#.md#.md#.md#.md#), which replaces the Hide in Plain Sight feature*

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](../../../Rules%20&%20Options/5e%20Rules/conditions.md##invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](../../../Rules%20&%20Options/5e%20Rules/conditions.md##exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](../../../Rules%20&%20Options/5e%20Rules/actions.md##Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](../../../Rules%20&%20Options/5e%20Rules/conditions.md.md##invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](../../../Rules%20&%20Options/5e%20Rules/conditions.md##blinded) or [deafened](../../../Rules%20&%20Options/5e%20Rules/conditions.md##deafened).
...
> ![Fighting Style, Ranger](../../optional-features/list-fighting-style-ranger.md##Fighting Style, Ranger)
