...
A creature that can see the sensor (such as one using [see invisibility](./see-invisibility.md#) or [truesight](../../Rules%20&%20Options/5e%20Rules/senses.md##truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
