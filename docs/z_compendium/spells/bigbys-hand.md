...
The hand attempts to push a creature within 5 feet of it in a direction you choose. Make a check with the hand's Strength contested by the Strength ([Athletics](../../Rules%20&%20Options/5e%20Rules/skills.md##Athletics)) check of the target. If the target is Medium or smaller, you have advantage on the check. If you succeed, the hand pushes the target up to 5 feet plus a number of feet equal to five times your spellcasting ability modifier. The hand moves with the target to remain within 5 feet of it.
...
**Classes**: [Artificer](../classes/artificer-tce.md#), [Warlock (The Fathomless)](../classes/warlock-the-fathomless-tce.md#), [Wizard](../classes/wizard.md#)

Player's Handbook p. 218. Available in the SRD (as 'Arcane Hand').