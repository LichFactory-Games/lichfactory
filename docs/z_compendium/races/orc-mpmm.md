...
# Orc
*Mordenkainen Presents: Monsters of the Multiverse p. 28*
![](../../assets/img/orc.png)  
...
You can take the [Dash](../../Rules%20&%20Options/5e%20Rules/actions.md##Dash) action as a bonus action. You can use this trait a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.
