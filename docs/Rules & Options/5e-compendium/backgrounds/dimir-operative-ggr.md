...
---
# Dimir Operative
*Guildmasters' Guide to Ravnica p. 46*  

- **Skill Proficiencies.** [Deception](../../5e-rules/skills.md##Deception), [Stealth](../../5e-rules/skills.md##Stealth)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](../spells/encode-thoughts-ggr.md#), [mage hand](../spells/mage-hand.md#) |
| 1st | [disguise self](../spells/disguise-self.md#), [sleep](../spells/sleep.md#) |
| 2nd | [detect thoughts](../spells/detect-thoughts.md#), [pass without trace](../spells/pass-without-trace.md#) |
| 3rd | [gaseous form](../spells/gaseous-form.md#), [meld into stone](../spells/meld-into-stone.md#), [nondetection](../spells/nondetection.md#) |
| 4th | [arcane eye](../spells/arcane-eye.md#), [freedom of movement](../spells/freedom-of-movement.md#) |
| 5th | [modify memory](../spells/modify-memory.md#) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](../spells/encode-thoughts-ggr.md#.md#) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
