...
You are proficient in one of the following skills of your choice: [Arcana](../../5e-rules/skills.md##Arcana), [History](../../5e-rules/skills.md##History), [Investigation](../../5e-rules/skills.md##Investigation), [Medicine](../../5e-rules/skills.md##Medicine), [Performance](../../5e-rules/skills.md##Performance), or [Sleight of Hand](../../5e-rules/skills.md##Sleight of Hand). You are also proficient with one "tool" of your choice.
