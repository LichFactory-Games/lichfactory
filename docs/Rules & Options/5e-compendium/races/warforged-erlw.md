...
Although they were manufactured, warforged are living humanoids. Resting, healing magic, and the [Medicine](../../5e-rules/skills.md##Medicine) skill all provide the same benefits to warforged that they do to other humanoids.
...
- You have advantage on saving throws against being [poisoned](../../5e-rules/conditions.md##poisoned), and you have resistance to poison damage.  
...
When you take a long rest, you must spend at least six hours in an inactive, motionless state, rather than sleeping. In this state, you appear inert, but it doesn't render you [unconscious](../../5e-rules/conditions.md##unconscious), and you can see and hear as normal.
