...
- **Craftiness.** You have proficiency in one of the following skills of your choice: [Arcana](../../5e-rules/skills.md##Arcana), [Investigation](../../5e-rules/skills.md##Investigation), [Medicine](../../5e-rules/skills.md##Medicine), [Sleight of Hand](../../5e-rules/skills.md##Sleight of Hand), or [Survival](../../5e-rules/skills.md##Survival).  
- **Defiance.** You have advantage on saving throws to avoid or end the [frightened](../../5e-rules/conditions.md##frightened) condition on yourself.  
