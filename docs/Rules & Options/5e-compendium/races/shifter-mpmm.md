...
Channeling the beast within, you have proficiency in one of the following skills of your choice: [Acrobatics](../../5e-rules/skills.md##Acrobatics), [Athletics](../../5e-rules/skills.md##Athletics), [Intimidation](../../5e-rules/skills.md##Intimidation), or [Survival](../../5e-rules/skills.md##Survival).
...
- **Wildhunt.** While shifted, you have advantage on Wisdom checks, and no creature within 30 feet of you can make an attack roll with advantage against you unless you're [incapacitated](../../5e-rules/conditions.md##incapacitated).