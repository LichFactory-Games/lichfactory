...
You are a master at saying the right thing at the right time. When you make a Charisma ([Persuasion](../../5e-rules/skills.md##Persuasion)) or Charisma ([Deception](../../5e-rules/skills.md##Deception)) check, you can treat a `d20` roll of 9 or lower as a 10.
