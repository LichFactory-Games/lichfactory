...
When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the [Intimidation](../../5e-rules/skills.md##Intimidation) or [Persuasion](../../5e-rules/skills.md##Persuasion) skill (your choice).
...
As an action, you present your holy symbol, and each creature of your choice that can see or hear you within 30 feet of you must succeed on a Wisdom saving throw or be [charmed](../../5e-rules/conditions.md##charmed) by you until the end of your next turn or until the [charmed](../../5e-rules/conditions.md##charmed) creature takes any damage. You can also cause any of the [charmed](../../5e-rules/conditions.md##charmed) creatures to drop what they are holding when they fail the saving throw.
