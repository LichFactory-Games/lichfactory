...
When you use this feature, you gain one level of [exhaustion](../../5e-rules/conditions.md##exhaustion). Only by finishing a long rest can you remove a level of [exhaustion](../../5e-rules/conditions.md##exhaustion) gained in this way.