...
The sidekick is adept at giving well-timed assistance; the sidekick can take the [Help](../../5e-rules/actions.md##Help) action as a bonus action.

### Cunning Action (Level 2)

*2nd-level Expert feature*

The sidekick's agility or quick thinking allows it to act speedily. On its turn in combat, it can take the [Dash](../../5e-rules/actions.md##Dash), [Disengage](../../5e-rules/actions.md##Disengage), or [Hide](../../5e-rules/actions.md##Hide) action as a bonus action.
