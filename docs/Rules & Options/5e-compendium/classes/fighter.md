...
*4th-level fighter [optional class features](../../5e-rules/variant-rules/optional-class-features-tce.md#)*
...
At 11th level, you can attack three times whenever you take the [Attack](../../5e-rules/actions.md.md##Attack) action on your turn.
...
At 20th level, you can attack four times whenever you take the [Attack](../../5e-rules/actions.md.md.md##Attack) action on your turn.
