...
While manifested, the spectral mind can hear and see, and it has [darkvision](../../5e-rules/senses.md##darkvision) with a range of 60 feet. The mind can telepathically share with you what it sees and hears (no action required).
...
Your connection to your Awakened Spellbook has become so profound that your soul has become entwined with it. While the book is on your person, you have advantage on all Intelligence ([Arcana](../../5e-rules/skills.md##Arcana)) checks, as the spellbook helps you remember magical lore.
