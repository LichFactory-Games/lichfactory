...
In addition, the sidekick gains proficiency in two skills of your choice from the following list: [Acrobatics](../../5e-rules/skills.md##Acrobatics), [Animal Handling](../../5e-rules/skills.md##Animal Handling), [Athletics](../../5e-rules/skills.md##Athletics), [Intimidation](../../5e-rules/skills.md##Intimidation), [Nature](../../5e-rules/skills.md##Nature), [Perception](../../5e-rules/skills.md##Perception), and [Survival](../../5e-rules/skills.md##Survival).
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](../../5e-rules/actions.md##Attack) action on its turn.
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](../../5e-rules/actions.md.md##Attack) action on its turn.
