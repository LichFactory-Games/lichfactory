...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](../../5e-rules/conditions.md##unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](../../5e-rules/conditions.md##blinded), [deafened](../../5e-rules/conditions.md##deafened), or [incapacitated](../../5e-rules/conditions.md##incapacitated).
...
*3rd-level barbarian [optional class features](../../5e-rules/variant-rules/optional-class-features-tce.md#)*
...
Additionally, if you are surprised at the beginning of combat and aren't [incapacitated](../../5e-rules/conditions.md.md##incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian [optional class features](../../5e-rules/variant-rules/optional-class-features-tce.md#.md#)*
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](../../5e-rules/conditions.md.md##unconscious) or if you choose to end it.
