...
In combat, the zombie's turn comes immediately after yours. It obeys your mental commands, and the only action it can take is the [Attack](../../5e-rules/actions.md##Attack) action, making one melee attack.
...
At 14th level, the fungal spores in your body alter you: you can't be [blinded](../../5e-rules/conditions.md##blinded), [deafened](../../5e-rules/conditions.md##deafened), [frightened](../../5e-rules/conditions.md##frightened), or [poisoned](../../5e-rules/conditions.md##poisoned), and any critical hit against you counts as a normal hit instead, unless you're [incapacitated](../../5e-rules/conditions.md##incapacitated).