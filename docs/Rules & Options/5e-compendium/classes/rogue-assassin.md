...
Your ruse is indiscernible to the casual observer. If a wary creature suspects something is amiss, you have advantage on any Charisma ([Deception](../../5e-rules/skills.md##Deception)) check you make to avoid detection.
