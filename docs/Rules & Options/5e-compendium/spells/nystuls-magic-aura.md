...
You change the way the target appears to spells and magical effects that detect creature types, such as a paladin's [Divine Sense](5e-compendium/classes/paladin.md#Divine%20Sense%20(Level%201)) or the trigger of a [symbol](./symbol.md#) spell. You choose a creature type and other spells and magical effects treat the target as if it were a creature of that type or of that alignment.
