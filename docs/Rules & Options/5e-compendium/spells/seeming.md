...
A creature can use its action to inspect a target and make an Intelligence ([Investigation](../../5e-rules/skills.md##Investigation)) check against your spell save DC. If it succeeds, it becomes aware that the target is disguised.
