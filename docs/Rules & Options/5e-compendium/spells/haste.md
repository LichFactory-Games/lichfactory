...
Choose a willing creature that you can see within range. Until the spell ends, the target's speed is doubled, it gains a +2 bonus to AC, it has advantage on Dexterity saving throws, and it gains an additional action on each of its turns. That action can be used only to take the [Attack](../../5e-rules/actions.md##Attack) (one weapon attack only), [Dash](../../5e-rules/actions.md##Dash), [Disengage](../../5e-rules/actions.md##Disengage), [Hide](../../5e-rules/actions.md##Hide), or [Use an Object](../../5e-rules/actions.md##Use an Object) action.
