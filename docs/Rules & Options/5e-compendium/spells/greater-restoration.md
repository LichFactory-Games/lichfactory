...
You imbue a creature you touch with positive energy to undo a debilitating effect. You can reduce the target's [exhaustion](../../5e-rules/conditions.md##exhaustion) level by one, or end one of the following effects on the target:

- One effect that [charmed](../../5e-rules/conditions.md##charmed) or [petrified](../../5e-rules/conditions.md##petrified) the target  
