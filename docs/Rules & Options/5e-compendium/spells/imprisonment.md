...
Heavy chains, firmly rooted in the ground, hold the target in place. The target is [restrained](../../5e-rules/conditions.md##restrained) until the spell ends, and it can't move or be moved by any means until then.
