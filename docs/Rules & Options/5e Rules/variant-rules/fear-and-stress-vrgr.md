...
The [calm emotions](../../../z_compendium/spells/calm-emotions.md#) spell effect used to suppress the [charmed](../conditions.md##charmed) and [frightened](../conditions.md.md.md##frightened) conditions also suppresses the effects of one's Stress Score for the spell's duration.
