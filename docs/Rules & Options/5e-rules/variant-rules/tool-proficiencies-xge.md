...
Tools have more specific applications than skills. The [History](../skills.md##History) skill applies to any event in the past. A tool such as a [forgery kit](forgery-kit.md#) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
[alchemist's supplies](alchemists-supplies.md#.md#) include two glass beakers, a metal frame to hold a beaker in place over an open flame, a glass stirring rod, a small mortar and pestle, and a pouch of common alchemical ingredients, including salt, powdered iron, and purified water.

#### Arcana

Proficiency with [alchemist's supplies](alchemists-supplies.md#.md#.md#) allows you to unlock more information on [Arcana](../skills.md##Arcana) checks involving potions and similar materials.

#### Investigation

When you inspect an area for clues, proficiency with [alchemist's supplies](alchemists-supplies.md#.md#.md#.md#) grants additional insight into any chemicals or other substances that might have been used in the area.

#### Alchemical Crafting

You can use this tool proficiency to create alchemical items. A character can spend money to collect raw materials, which weigh 1 pound for every 50 gp spent. The DM can allow a character to make a check using the indicated skill with advantage. As part of a long rest, you can use [alchemist's supplies](alchemists-supplies.md#.md#.md#.md#.md#) to make one dose of [acid](acid-vial.md#), [alchemist's fire](alchemists-fire-flask.md#), [antitoxin](antitoxin-vial.md#), [oil](oil-flask.md#), [perfume](perfume-vial.md#), or [soap](soap.md#). Subtract half the value of the created item from the total gp worth of raw materials you are carrying.
...
Proficiency with [brewer's supplies](brewers-supplies.md#.md#) gives you additional insight on Intelligence ([History](../skills.md.md##History)) checks concerning events that involve alcohol as a significant element.
...
A stiff drink can help soften the hardest heart. Your proficiency with [brewer's supplies](brewers-supplies.md#.md#.md#) can help you ply someone with drink, giving them just enough alcohol to mellow their mood.
...
[Cartographer's tools](cartographers-tools.md#.md#) consist of a quill, ink, parchment, a pair of compasses, calipers, and a ruler.
...
With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](../skills.md.md##Investigation)) check DC needed to find the compartment.
...
As part of a short rest, you can prepare a tasty meal that helps your companions regain their strength. You and up to five creatures of your choice regain 1 extra hit point per Hit Die spent during a short rest, provided you have access to your [cook's utensils](cooks-utensils.md#.md#) and sufficient food.
...
A [disguise kit](disguise-kit.md#.md#) includes cosmetics, hair dye, small props, and a few pieces of clothing.
...
A [forgery kit](forgery-kit.md#.md#) is designed to duplicate documents and to make it easier to copy a person's seal or signature.

#### Components

A [forgery kit](forgery-kit.md#.md#.md#) includes several different types of ink, a variety of parchments and papers, several quills, seals and sealing wax, gold and silver leaf, and small tools to sculpt melted wax to mimic a seal.

#### Arcana

A [forgery kit](forgery-kit.md#.md#.md#.md#) can be used in conjunction with the [Arcana](../skills.md.md##Arcana) skill to determine if a magic item is real or fake.
...
A [forgery kit](forgery-kit.md#.md#.md#.md#.md#) combined with your knowledge of history improves your ability to create fake historical documents or to tell if an old document is authentic.

#### Investigation

When you examine objects, proficiency with a [forgery kit](forgery-kit.md#.md#.md#.md#.md#.md#) is useful for determining how an object was made and whether it is genuine.

#### Other Tools

Knowledge of other tools makes your forgeries that much more believable. For example, you could combine proficiency with a [forgery kit](forgery-kit.md#.md#.md#.md#.md#.md#.md#) and proficiency with [cartographer's tools](cartographers-tools.md#.md#.md#) to make a fake map.

#### Quick Fake

As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](forgery-kit.md#.md#.md#.md#.md#.md#.md#.md#) determines the DC for someone else's Intelligence ([Investigation](../skills.md.md.md##Investigation)) check to spot the fake.
...
[Sleight of Hand](../skills.md##Sleight of Hand) is a useful skill for cheating at a game, as it allows you to swap pieces, palm cards, or alter a die roll. Alternatively, engrossing a target in a game by manipulating the components with dexterous movements is a great distraction for a pickpocketing attempt.
...
An [herbalism kit](herbalism-kit.md#.md#) includes pouches to store herbs, clippers and leather gloves for collecting plants, a mortar and pestle, and several glass jars.
...
[Jeweler's tools](jewelers-tools.md#.md#) consist of a small saw and hammer, files, pliers, and tweezers.

#### Arcana

Proficiency with [jeweler's tools](jewelers-tools.md#.md#.md#) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](../skills.md.md.md##Arcana) checks related to gems or gem-encrusted items.

#### Investigation

When you inspect jeweled objects, your proficiency with [jeweler's tools](jewelers-tools.md#.md#.md#.md#) aids you in picking out clues they might hold.
...
[Mason's tools](masons-tools.md#.md#) allow you to craft stone structures, including walls and buildings crafted from brick.

#### Components

[Mason's tools](masons-tools.md#.md#.md#) consist of a trowel, a hammer, a chisel, brushes, and a square.
...
[Navigator's tools](navigators-tools.md#.md#) include a sextant, a compass, calipers, a ruler, parchment, ink, and a quill.

#### Survival

Knowledge of [navigator's tools](navigators-tools.md#.md#.md#) helps you avoid becoming lost and also grants you insight into the most likely location for roads and settlements.
...
[Painter's supplies](painters-supplies.md#.md#) include an easel, canvas, paints, brushes, charcoal sticks, and a palette.
...
A [poisoner's kit](poisoners-kit.md#.md#) includes glass vials, a mortar and pestle, chemicals, and a glass stirring rod.
...
| Activity | DC |
|----------|----|
| Spot a [poisoned](../conditions.md.md##poisoned) object | 10 |
...
[Potter's tools](potters-tools.md#.md#) include potter's needles, ribs, scrapers, a knife, and calipers.
...
[Smith's tools](smiths-tools.md#.md#) include hammers, tongs, charcoal, rags, and a whetstone.
...
[Thieves' tools](thieves-tools.md#.md#) include a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers.
...
[Tinker's tools](tinkers-tools.md#.md#) include a variety of hand tools, thread, needles, a whetstone, scraps of cloth and leather, and a small pot of glue.
...
[Weaver's tools](weavers-tools.md#.md#) include thread, needles, and scraps of cloth. You know how to work a loom, but such equipment is too large to transport.
...
[Woodcarver's tools](woodcarvers-tools.md#.md#) consist of a knife, a gouge, and a small saw.
