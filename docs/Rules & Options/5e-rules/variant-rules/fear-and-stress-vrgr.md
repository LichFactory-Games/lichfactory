...
Any of the following circumstances might be reasons to have one or more characters make saving throws to resist being [frightened](../conditions.md.md##frightened):
...
The [calm emotions](../../5e-compendium/spells/calm-emotions.md#) spell effect used to suppress the [charmed](../conditions.md##charmed) and [frightened](../conditions.md.md.md##frightened) conditions also suppresses the effects of one's Stress Score for the spell's duration.

A [lesser restoration](../../5e-compendium/spells/lesser-restoration.md#) spell reduces the target's Stress Score by 1, and a [greater restoration](../../5e-compendium/spells/greater-restoration.md#) spell reduces a character's Stress Score to 0.