...
The most potent personal changes inspired by team building can last a lifetime. Or at least an encounter. A character who earns a team building memory gains an extraordinary ability that can be used once. As a bonus action, the character gains one effect of the [enhance ability](../../5e-compendium/spells/enhance-ability.md#) spell for 10 minutes (no [concentration](../conditions.md##concentration) required).
