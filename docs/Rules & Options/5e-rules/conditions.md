...
The DM might also decide that certain environmental phenomena, such as a wave crashing over you while you're on a storm-tossed ship, require you to succeed on a DC 10 Constitution saving throw to maintain [concentration](conditions.md.md.md.md##concentration) on a spell.
...
## Falling Fortunes
_Source: Tome of Beasts 2 p. 241_

A creature cursed with falling fortunes is plagued with bad luck for 24 hours. While cursed, the creature can't add its proficiency bonus to any attack rolls or ability checks. If the cursed creature rolls a 20 on an attack roll or an ability check, the curse ends. Alternatively, the curse can be lifted early by a [remove curse](../5e-compendium/spells/remove-curse.md#) spell or similar magic.
...
- The condition also ends if an effect removes the grappled creature from the reach of the grappler or grappling effect, such as when a creature is hurled away by the [thunderwave](../5e-compendium/spells/thunderwave.md#) spell.  
...
- An unconscious creature is [incapacitated](conditions.md.md.md.md.md.md##incapacitated), can't move or speak, and is unaware of its surroundings.  
